...
アプリ内の **設定 → 🌐 URLから取得** で以下のURLを入力してください：

### 基本プリセット (v1.0)
```
https://github.com/Kake-git-hub/DressUpGame/releases/download/preset-v1.0/kisekae-basic-v1.0.zip
```

**内容:**
- ドール: 1体
- 背景: 複数枚
- 服: 100着以上（ドレス、トップス、ボトムス、靴、帽子、アクセサリーなど）
...
6. **🖼️はいけい** ボタンで背景を変更
7. **📸ボタン** でスクリーンショット保存（ドールと背景は自動で中央）
